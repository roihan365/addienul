            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                        ...
                        <img src="{{ asset('assets/dashboard/images/profile/user-1.jpg') }}" alt=""
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <div class="message-body">
                            ...
                            <div class="mt-2 mx-3"> <!-- Tambahkan wrapper div -->
                                <form method="POST" action="{{ route('logout') }}" class="w-100">
                                    <!-- Tambahkan class w-100 pada form -->
                                    @csrf
                                    <button type="submit" class="btn btn-outline-primary d-block w-100">Logout</button>
                                    <!-- Tambahkan class w-100 pada button -->
                                </form>
                            </div>
                        </div>
                    </div>
