 ...
 *   https://datatables.net/download/#bs5/dt-1.13.10/b-2.4.2/b-html5-2.4.2/r-2.5.0
 *
 * Included libraries:
 *   DataTables 1.13.10, Buttons 2.4.2, HTML5 export 2.4.2, Responsive 2.5.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.10/b-2.4.2/b-html5-2.4.2/r-2.5.0",
